...
export default function Header() {
  ...
  return (
    <header className={`fixed top-0 w-full md:p-16 p-8 z-50 flex justify-between items-center`}>
      {/* Logo */}
      <Link href='/'>
        <div className='clickable text-black font-homemade md:text-5xl text-4xl'>{`mitsch`}</div>
      </Link>
      {/* Burger Menu Icon */}
